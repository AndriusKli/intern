...
public class AlbumTests {
    ...
    private final ITunesResponse albumResponse = new ITunesResponse(resultCount, results);
    ...
    void whenAlbumIsNotInDb_thenRetrievesAlbumAndSongs_andThenPersists() {
        when(iTunesFeignClient.getById(ALBUM_ID)).thenReturn(albumResponse);
        when(iTunesFeignClient.getAlbumSongs(ALBUM_ID)).thenReturn(albumResponse);
