...
public interface PlaylistApi {
    ...
    ResponseEntity<List<Playlist>> getPlaylists(@ApiParam(value = "User whose playlists you want to retrieve") String accessToken);

    @ApiOperation(value = "Get a specific playlist", notes = "Gets a specific playlist belonging to a user.")
    ResponseEntity<Playlist> getPlaylist(@ApiParam(value = "User whose playlist you want to retrieve") String accessToken,
    ...
    ResponseEntity<Playlist> createPlaylist(@ApiParam(value = "User for whom you want to create a new playlist") String accessToken,
                                            @ApiParam(value = "The name you want to give to the playlist." +
                                                    " Note that all other additional properties other than \"playlistName\" will be ignored.") Playlist playlist);

    @ApiOperation(value = "Update a playlist's name", notes = "Updates a specified playlist's name")
    ResponseEntity<Playlist> updatePlaylist(@ApiParam(value = "User for whom you want to update the playlist") String accessToken,
    ...
    ResponseEntity<Void> addSongToPlaylist(@ApiParam(value = "The id of the user to whom the playlist belongs to") String accessToken,
    ...
    ResponseEntity<Void> removeSongFromPlaylist(@ApiParam(value = "The id of the user to whom the playlist belongs to") String accessToken,
